...
const routerHostName = routerInfo["Cisco-IOS-XE-native:native"].hostname;
const dataArp = arpTable["Cisco-IOS-XE-arp-oper:arp-data"]["arp-vrf"][0]["arp-oper"];

const filterAddresses = function (arpData: DataArpPops[]) {
...
export const hostNameRouter=routerHostName;
